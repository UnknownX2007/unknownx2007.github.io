...
$(document).ready(function() {
    ...
    //Thay đổi giao diện Navbar khi cuộn trang
    ...
    // Hiệu ứng cuộn mượt khi nhấn vào link (Smooth Scrolling)
    ...
    // Log ra console khi một card được click
